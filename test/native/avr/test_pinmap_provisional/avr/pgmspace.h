 ...
 * host we just neutralize these to no-ops / direct memory access so the
 * test binary can link.
 *
 * Scope: ONLY for this suite. Not for production builds. Production builds
 * use the real AVR libc header via the Arduino framework.
 */
