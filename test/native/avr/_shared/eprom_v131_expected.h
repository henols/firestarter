 ...
 * the dump's own banners: EPROM_V131_TRACE_PROTO_07 total=121,
 * EPROM_V131_TRACE_PROTO_08 total=148, EPROM_V131_TRACE_PROTO_0B total=92
 * (Phase 144's own capture read 91 / 115 / 59 — see the route-assert
 * paragraph above for why all three grew) — all three with
...
static const v131_trace_entry_t EPROM_V131_TRACE_PROTO_07[] = {
    ...
    {3, 0x00, 0x00, 1UL}, /* 23 */
    {2, 0x08, 0x00, 0UL}, /* 24 */
    {3, 0x00, 0x00, 1000UL}, /* 25 */
    {2, 0x04, 0x01, 0UL}, /* 26 */
    {1, 0x00, 0x55, 0UL}, /* 27 */
    {3, 0x00, 0x00, 3UL}, /* 28 */
    {2, 0x20, 0x00, 0UL}, /* 29 */
    {3, 0x00, 0x00, 100UL}, /* 30 */
    {2, 0x20, 0x01, 0UL}, /* 31 */
    {3, 0x00, 0x00, 100UL}, /* 32 */
    {1, 0x00, 0x91, 0UL}, /* 33 */
    {2, 0x08, 0x01, 0UL}, /* 34 */
    {3, 0x00, 0x00, 1UL}, /* 35 */
    {2, 0x08, 0x00, 0UL}, /* 36 */
    ...
    {3, 0x00, 0x00, 1UL}, /* 43 */
    {2, 0x08, 0x00, 0UL}, /* 44 */
    {3, 0x00, 0x00, 1000UL}, /* 45 */
    {2, 0x04, 0x01, 0UL}, /* 46 */
    {1, 0x00, 0x55, 0UL}, /* 47 */
    {3, 0x00, 0x00, 3UL}, /* 48 */
    {2, 0x20, 0x00, 0UL}, /* 49 */
    {3, 0x00, 0x00, 100UL}, /* 50 */
    {2, 0x20, 0x01, 0UL}, /* 51 */
    ...
    {3, 0x00, 0x00, 1UL}, /* 71 */
    {2, 0x08, 0x00, 0UL}, /* 72 */
    {3, 0x00, 0x00, 1000UL}, /* 73 */
    {2, 0x04, 0x01, 0UL}, /* 74 */
    {1, 0x00, 0xAA, 0UL}, /* 75 */
    {3, 0x00, 0x00, 3UL}, /* 76 */
    {2, 0x20, 0x00, 0UL}, /* 77 */
    {3, 0x00, 0x00, 100UL}, /* 78 */
    {2, 0x20, 0x01, 0UL}, /* 79 */
    {3, 0x00, 0x00, 100UL}, /* 80 */
    {1, 0x00, 0x91, 0UL}, /* 81 */
    {2, 0x08, 0x01, 0UL}, /* 82 */
    {3, 0x00, 0x00, 1UL}, /* 83 */
    {2, 0x08, 0x00, 0UL}, /* 84 */
...
static const v131_trace_entry_t EPROM_V131_TRACE_PROTO_08[] = {
    ...
    {3, 0x00, 0x00, 3UL}, /* 32 */
    {2, 0x20, 0x00, 0UL}, /* 33 */
    {3, 0x00, 0x00, 100UL}, /* 34 */
    {2, 0x20, 0x01, 0UL}, /* 35 */
    {3, 0x00, 0x00, 100UL}, /* 36 */
    {1, 0x00, 0x80, 0UL}, /* 37 */
    {2, 0x08, 0x01, 0UL}, /* 38 */
    {3, 0x00, 0x00, 1UL}, /* 39 */
    {2, 0x08, 0x00, 0UL}, /* 40 */
    ...
    {3, 0x00, 0x00, 3UL}, /* 61 */
    {2, 0x20, 0x00, 0UL}, /* 62 */
    {3, 0x00, 0x00, 100UL}, /* 63 */
    {2, 0x20, 0x01, 0UL}, /* 64 */
    {3, 0x00, 0x00, 100UL}, /* 65 */
    {1, 0x00, 0x80, 0UL}, /* 66 */
    {2, 0x08, 0x01, 0UL}, /* 67 */
    {3, 0x00, 0x00, 1UL}, /* 68 */
    {2, 0x08, 0x00, 0UL}, /* 69 */
    ...
    {3, 0x00, 0x00, 3UL}, /* 98 */
    {2, 0x20, 0x00, 0UL}, /* 99 */
    {3, 0x00, 0x00, 100UL}, /* 100 */
    {2, 0x20, 0x01, 0UL}, /* 101 */
    {3, 0x00, 0x00, 100UL}, /* 102 */
    {1, 0x00, 0x80, 0UL}, /* 103 */
    {2, 0x08, 0x01, 0UL}, /* 104 */
    {3, 0x00, 0x00, 1UL}, /* 105 */
    {2, 0x08, 0x00, 0UL}, /* 106 */
...
static const v131_trace_entry_t EPROM_V131_TRACE_PROTO_0B[] = {
    ...
    {3, 0x00, 0x00, 1UL}, /* 44 */
    {2, 0x08, 0x00, 0UL}, /* 45 */
    {3, 0x00, 0x00, 1000UL}, /* 46 */
    {2, 0x04, 0x01, 0UL}, /* 47 */
    {1, 0x00, 0x55, 0UL}, /* 48 */
    {3, 0x00, 0x00, 3UL}, /* 49 */
    {2, 0x20, 0x00, 0UL}, /* 50 */
    {3, 0x00, 0x00, 500UL}, /* 51 */
    {2, 0x20, 0x01, 0UL}, /* 52 */
    ...
    {3, 0x00, 0x00, 1UL}, /* 73 */
    {2, 0x08, 0x00, 0UL}, /* 74 */
    {3, 0x00, 0x00, 1000UL}, /* 75 */
    {2, 0x04, 0x01, 0UL}, /* 76 */
    {1, 0x00, 0xAA, 0UL}, /* 77 */
    {3, 0x00, 0x00, 3UL}, /* 78 */
    {2, 0x20, 0x00, 0UL}, /* 79 */
    {3, 0x00, 0x00, 500UL}, /* 80 */
    {2, 0x20, 0x01, 0UL}, /* 81 */
    {3, 0x00, 0x00, 100UL}, /* 82 */
    {1, 0x00, 0x80, 0UL}, /* 83 */
    {2, 0x08, 0x01, 0UL}, /* 84 */
    {3, 0x00, 0x00, 1UL}, /* 85 */
    {2, 0x08, 0x00, 0UL}, /* 86 */
