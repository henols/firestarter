 ...
 *
 * Phase 12 Wave 1 — host stub TU for the test_eeprom28c_chip_id suite.
 ...
 * The shared include provides no-op host implementations of every rurp_*
 * symbol the proms reference, plus the PROGMEM log-tag globals from
 * src/logging.c, so the test binary can link.
 *
 * Suite-specific extensions: NONE — test_eeprom28c_chip_id uses the
 * canonical default for every stub. This TU is a pure pass-through to
 * the shared include.
 *
