 ...
 *
 * Phase 44 Plan 02 — host stub TU for the test_read_timing suite.
 ...
 * PROGMEM log-tag globals from src/logging.c, so the read-timing test binary
 * can link.
 *
 * Suite-specific extensions: NONE — test_read_timing uses the canonical
