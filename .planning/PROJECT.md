...
channel, and no version string separates fixed from unfixed firmware: `3.0.0b31` / `3.0.0b46` read the
same on `beta` and at the milestone tip. Ship via `/gsd-ship`, bumping first.
