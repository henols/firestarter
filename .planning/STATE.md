...
stopped_at: "v1.40 SHIPPED AND PUBLISHED 2026-09-20. All three PRs merged to beta (firestarter#91, firestarter_app#72, firestarter_fw#70). Published: firestarter_app 3.0.0b49 (GitHub pre-release + PyPI) and firestarter_fw 3.0.0b34 (pre-release, 4 .hex assets verified). Bare v1.40 tag pushed to the meta repo; zero GitHub Releases there, as required. All three held answers POSTED to gh#70/gh#66/gh#71, so PULSE-04, VOLT-04 and RAIL-05 are now Complete — 22/24. Two rename PRs also merged, cutting app 3.0.0b50 and fw 3.0.0b35. Next — /gsd-new-milestone at phase 202."
last_updated: "2026-09-20T13:00:00.000Z"
last_activity: 2026-09-20
last_activity_desc: "Closed and hand-archived milestone v1.40 Program-Parameter Fidelity — 5 phases (197-201), 26 plans, 65 tasks, 19/24 requirements, override_closeout. Archive at .planning/milestones/v1.40-{CLOSE-RECORD,ROADMAP,REQUIREMENTS}.md and v1.40-phases/. milestone.complete and audit-open acknowledge both deliberately not run; 88 open artifacts disclosed by hand with 0 suppressed. SHIPPED 2026-09-20: branches pushed to origin in all three repos and PRs opened to beta — firestarter#91, firestarter_app#72, firestarter_fw#70. No merge, so nothing is published and no PyPI version is burned; the three held issue answers remain unposted. PUBLISHED 2026-09-20: all three PRs merged; app 3.0.0b49 on PyPI, fw 3.0.0b34 with assets; v1.40 bare tag pushed; gh#70/gh#66/gh#71 answered, PULSE-04/VOLT-04/RAIL-05 flipped Complete (22/24). The earlier 'nothing is published / answers unposted' clause in this line is superseded by this sentence."
progress:
  total_phases: 5
  completed_phases: 5
  total_plans: 26
...
**Current focus:** v1.40 **SHIPPED AND PUBLISHED** 2026-09-20. All three PRs merged to `beta`. Published: `firestarter_app` **3.0.0b49** (GitHub pre-release + PyPI, verified) and `firestarter_fw` **3.0.0b34** (pre-release with all four `.hex` assets attached, verified). The bare `v1.40` tag is pushed and the meta repo still carries **zero** GitHub Releases, which is the standing requirement. All three held answers are POSTED — gh#70, gh#66, gh#71 — so **PULSE-04, VOLT-04 and RAIL-05 are Complete: 22 of 24**. Two long-open rename PRs were also merged (cutting app `3.0.0b50`, fw `3.0.0b35`); `firestarter_fw#67` is deliberately DEFERRED because `build.yml` lacks a `.github/**` ignore and would cut a stale stable release off `main`. Next: `/gsd-new-milestone`. Phases continue at **202**.
