...
<!-- Frozen copy of .planning/REQUIREMENTS.md as it stood at the v1.40 close (2026-09-20).
     The live file stays in place for /gsd-new-milestone to replace — the `git rm` step
     stopped being used after v1.35. -->
