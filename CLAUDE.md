...
a value above 65535 is reachable on the wire independently of the host flag; reconciling that gap is
Phase 146 / CLOSE-04's. The firmware-side backstop that actually enforces a ceiling is
