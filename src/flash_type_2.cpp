...
void flash_2_write_data(firestarter_handle_t* handle);
void flash_2_check_chip_id(firestarter_handle_t* handle);

uint16_t flash_2_get_chip_id(firestarter_handle_t* handle);
...
void configure_flash_2(firestarter_handle_t* handle) {
    ...
    handle->firestarter_write_data = flash_2_write_data;
...
void flash_2_check_chip_id(firestarter_handle_t* handle) {
    uint16_t chip_id = flash_2_get_chip_id(handle);
