...
| Rev 2.2 | UV-EPROM 28-pin DIP, UV-EPROM 32-pin DIP, 24-pin legacy DIP UV-EPROM, 28-pin AT28C EEPROM, AMD-style flash, Intel 28F flash, SRAM/NVRAM | 13 | 5 | 20 | 0x05, 0x06, 0x07, 0x08, 0x0B, 0x0D, 0x0E, 0x10, 0x27, 0x28, 0x29, 0x35, 0x39 | (none — R41 is detect-divider only; value RESOLVED 2026-05-26) | Capability unchanged from Rev 2.1. **R41 = 10 kΩ** (operator-confirmed lift-leg measurement 2026-05-26 — vindicates Anders chat-intel; schematic source blob f3b7a521 is stale, gerber BOM in Rev2.2-gerbers.zip is authoritative). |
...
| R41 | S | RES_HW_REVISION_DIVIDER | n/a | not-present | not-present | ✓ (4k7 — operator-confirmed 2026-05-26) | ✓ (4k7) | ✓ (10k — operator-confirmed 2026-05-26; schematic source stale, gerber BOM authoritative) | ✓ (10k) | as-modified — pending v1.8 |
...
| Rev 2.0 / 2.1 / 2.2 (R41 to GND via JP4) | R41 only to GND; A3 pulled low via MCU leakage | 0–199 (low band; empirical Phase 35 Wave 3 — Rev 2.0 with R41=4k7 + Rev 2.2 with R41=10k both land here, confirming the post-Plan-01 band-math is R41-value-agnostic when no R_top is active) | `REVISION_2_0` (= 2) | `"Rev 2.0-class"` |
